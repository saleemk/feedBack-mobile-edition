; Tauri CLI v2.11.4 NSIS template, customized for the Mobile Edition welcome page.
Unicode true
...
Function CreateOrUpdateDesktopShortcut
  ...
  ; An explicit finish-page request should also repair a stale shortcut during
  ; an update. Respect only the installer's no-shortcut mode here.
  ${If} $WixMode = 0
    ${If} $NoShortcutMode = 1
      Return
    ${EndIf}
